...
//		HuffmanEncoding thai = new HuffmanEncoding("encode3","test0.txt","output.txt.huffman");

		HuffmanEncoding thai2 = new HuffmanEncoding("encode","test0.txt","output.txt.huffman");
	}
	...
	public void testgetFreq() throws Exception { // testing countword
		...
		freq =  thai.en.getGetFreq(); // test1.txt has only 1 character "a"
		assertTrue(!freq.isEmpty());
		assertEquals((int)freq.get("01100001"), 1);
		assertTrue( freq.get("01100010") == null); // b is not in freq
		...
		freq =  thai.en.getGetFreq();  // test4.txt is a single newline
		assertTrue(!freq.isEmpty());
	...
	public void testTable() throws Exception {   // testing countword
		...
		thai = new HuffmanEncoding("encode","test1.txt","output.txt.huffman");
		table =  thai.en.getTable();  // test1.txt is only a character "a"
		assertTrue(!table.isEmpty());
	...
	public void testHuffmanTree() throws Exception { // to make sure the code map get the right bits string in the table
		...
		thai = new HuffmanEncoding("encode","test5.txt","output.txt.huffman");
		table =  thai.en.getTable();  // test5.txt is "it was the best of time , it was the worst of time"
		assertTrue(!table.isEmpty());  // n = 0
	...
	public void testDecoding() throws Exception {
		...
		thai = new HuffmanEncoding("encode","test5.txt","testDecoding5.txt.huffman");
		...
		FileCharIterator myIter2 = new FileCharIterator("testDecoding5.txt");
